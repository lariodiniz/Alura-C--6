...
namespace Csharp6.Aula03
{
    ...
    class Aluno07 : INotifyPropertyChanged
    {
        ...
        private IList<Avaliacao03> avaliacoes = new List<Avaliacao03>();

        public event PropertyChangedEventHandler PropertyChanged;

        public IReadOnlyCollection<Avaliacao03> Avaliacaos
              => new ReadOnlyCollection<Avaliacao03>(avaliacoes);

        public Avaliacao03 MelhorAvaliacao => avaliacoes.OrderBy(a => a.Nota).LastOrDefault();


        public void AdicionaAvaliacao(Avaliacao03 avaliacao)
        {
        ...
        public Aluno07(string nome, string sobreNome)
        {
            this.Nome = nome;
            this.SobreNome = sobreNome;
        }

        public Aluno07(string nome, string sobreNome, DateTime dataNascimento) :
            this(nome, sobreNome)
        {
    ...
    class Avaliacao03
    {
        public Avaliacao03(int bimestre, string materia, double nota)
        {
            Bimestre = bimestre;
            Materia = materia;
            Nota = nota;
